...
function Dashboard() {
  ...
  const acceptInvite = async ({ invite }) => {
    try {
      ...
      const response = await fetch(
        "http://localhost:5001/api/invite/acceptInvite",
        {
          method: "POST",
  ...
  const declineInvite = async ({ invite }) => {
    try {
      ...
      console.log(invite);
      const response = await fetch(
        "http://localhost:5001/api/invite/deleteInvite",
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const handleFileUpload = async (roomId, file) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5001/api/room/uploadRoomImage/${roomId}`,
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className={styles.dashboardAppContainer}>
      ...
      <div className={styles.dashboardBanner}>
        <div className={styles.header}>
          <h1>
            {userData.username ? `${userData.username}'s Rooms` : "Your Rooms"}
          </h1>
      ...
      <div className={styles.dashboardContent}>
        <div className={styles.contentHeading}>
          ...
          <p className={styles.subheading}>
            Manage and access your personal and shared spaces
          </p>
        </div>
        {isLoading ? (
              ...
              <div className={styles.roomsList}>
                <div className={styles.roomsGrid}>
                  ...
                  {Array.isArray(userData.rooms) &&
                    userData.rooms.length > 1 && (
                      <div className={styles.roomWrapper}>
                        <RoomDoor
                          roomName="Master Room"
                          onClick={() => navigate(`/room/master-room`)}
                        />
                      </div>
                    )}
                      ...
                      >
                        ...
                        >
                          ...
                          <p className={styles.roomCount}>
                            ...
                            {userData.rooms.length === 1 ? "room" : "rooms"}{" "}
                            available
                          </p>
                        </div>
                      </div>
            ...
            <div className={styles.infoColumn}>
              ...
              <div className={styles.infoBlocksContainer}>
                <div className={styles.infoBlock}>
                  ...
                  <p>
                    Ughhh how much did I spend on groceries? With our new
                    grocery splitting feature, you can easily track and split
                    Grociery expenses with your roommates.
                  </p>
                </div>
                ...
                <div className={styles.infoBlock}>
                  ...
                  <p>
                    Who payed rent, what about utilities? With our new bills and
                    expenses feature, you can easily track and split bills with
                    your roommates.
                  </p>
                </div>
                ...
                <div className={styles.infoBlock}>
                  ...
                  <p>
                    Ever need some peace and quiet? With our new quiet hours
                    feature, you can easily set quiet hours in the present and
                    future to give your roomates a headsup.
                  </p>
                </div>
                ...
                <div className={styles.infoBlock}>
                  ...
                  <p>
                    Who's turn was it to wash the dishes??? With our new chore
                    management feature, you can easily assign and track chores.
                  </p>
                </div>
                ...
                <div className={styles.infoBlock}>
                  ...
                  <p>
                    Ever want a peaceful way of telling your roomates what they
                    are good and what they are bad at. You can do it anonymously
                    in RoomEase!
                  </p>
                </div>
